...
switch (platform) {
  ...
  case 'darwin':
    localFileExisted = existsSync(
      join(__dirname, 'parcel-resolver.darwin-universal.node'),
    );
    try {
      if (localFileExisted) {
        nativeBinding = require('./parcel-resolver.darwin-universal.node');
      } else {
        nativeBinding = require('@parcel/node-resolver-core-darwin-universal');
      }
      break;
    } catch {}
    switch (arch) {
