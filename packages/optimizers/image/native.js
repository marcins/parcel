...
switch (platform) {
    ...
    switch (arch) {
      case 'arm64':
        localFileExisted = existsSync(
          join(__dirname, 'parcel-image.android-arm64.node'),
        );
        try {
          if (localFileExisted) {
      ...
      case 'arm':
        localFileExisted = existsSync(
          join(__dirname, 'parcel-image.android-arm-eabi.node'),
        );
        try {
          if (localFileExisted) {
  ...
  case 'darwin':
    localFileExisted = existsSync(
      join(__dirname, 'parcel-image.darwin-universal.node'),
    );
    try {
      if (localFileExisted) {
    ...
    switch (arch) {
      case 'x64':
        localFileExisted = existsSync(
          join(__dirname, 'parcel-image.darwin-x64.node'),
        );
        try {
          if (localFileExisted) {
  ...
  case 'freebsd':
    ...
    localFileExisted = existsSync(
      join(__dirname, 'parcel-image.freebsd-x64.node'),
    );
    try {
      if (localFileExisted) {
